...
import { getOngoingOrders } from '../service/comicAdminService'
import { RenderOrderStatus } from './utils/RenderOrderStatus'
import { CompleteOrderButton } from './utils/CompleteOrderButton'
...
export const OrderManagePage = () => {
  ...
  useEffect(() => {
    getOngoingOrders().then((res) => {setAllOrders(res.data); console.log(res.data)}).catch(e => console.log(e));
  }, [])
              ...
              return(
                <div key={order.id} className='bg-white container mx-auto p-2 flex flex-col border-[2px] border-black rounded-xl mt-12'>
                  ...
                  <div className='flex justify-between mt-4 items-center'>
                    ...
                    <CompleteOrderButton deliveryStatus={order.deliveryStatus} orderId={order.id}/>
                  </div>
                </div>
                    )
                })
